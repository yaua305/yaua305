        ...
        <div id="navwrapper">
            <div id="navbar">
                <table class="tablewrapper">
                    ...
                    <tr>
                        <td><input type="text" name="username" value="" required class="inputtext" />
                        </td>
                        <td><input type="text" name="password" value="" required class="inputtext" />
                        </td>
                        <td colspan="2" align="center"><input type="submit" name="dangky" value="Đăng nhập "></td>
                    </tr>
                    <tr>
                        <td>
